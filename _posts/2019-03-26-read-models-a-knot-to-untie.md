...
- in the first scenario, the fancy diagram, we end up with an incredibly fast but empty read storage. The storage that needs to be re-synchronized, with the risk of huge delays
